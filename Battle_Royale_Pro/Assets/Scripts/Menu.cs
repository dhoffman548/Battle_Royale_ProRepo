...
public class Menu : MonoBehaviourPunCallbacks, ILobbyCallbacks
{
    ...
    void Start ()
    {
        ...
        // enable the cursor since we hide it when the player is in the game
    ...
    void UpdateLobbyUI()
    {
        // enable or disable the start game button depending on the host 
        startGameButton.interactable = PhotonNetwork.IsMasterClient;
        startGameButton1.interactable = PhotonNetwork.IsMasterClient;
    ...
    public void OnStartGame1Button()
    {
        //hide the room
        PhotonNetwork.CurrentRoom.IsOpen = false;
        PhotonNetwork.CurrentRoom.IsVisible = false;
        ...
        // tell everyone to load into the game scene
        NetworkManager.instance.photonView.RPC("ChangeScene", RpcTarget.All, "Game1");
    }
